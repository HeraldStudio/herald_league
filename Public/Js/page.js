            ...
            success: function(data) {
                if (data) {
                    ...
                    for (i = 0; i < l; i++) {
                        n = data[i];
                        if (n.post_add) {
                            $items = '<div class="thumbnail"><a href="#" class="thumb"><img src="/herald_league/Uploads/ActivityPost/m_' + n.post_add + '" alt="alt" /></a><div class="heading center" style="font-size:20px;margin-top:20px;"><a data-toggle="modal" href="/herald_league/index.php/Activity/Index/activity/activityid/'+n.id+'" class="activityname" id="' + n.id + '">' + n.name + '</a></div><div class="word_wrap"><br/><p>主办方：<a href="#">' + n.league_name + '</a><a href="#" title="关注此社团"><img src="/herald_league/Public/Images/attention-small.png"/></a></p><p>时间：' + n.start_time + '</p><p>地点：' + n.place + '</p><br/><a class="btn btn-primary pull-right" data-toggle="modal" href="#myModal">浏览</a></div></div>';
                        } else {
                            $items = '<div class="thumbnail"><div class="heading center" style="font-size:20px;margin-top:20px;"><a href="/herald_league/index.php/Activity/Index/activity/activityid/'+n.id+'" class="activityname" id="' + n.id + '">' + n.name + '</a></div><div class="word_wrap"><br/><p>主办方：<a href="#">' + n.league_name + '</a></p><p>时间：' + n.start_time + '</p><p>地点：' + n.place + '</p><br/><a class="btn btn-primary pull-right" data-toggle="modal" href="#myModal">浏览</a></div></div>';
                        };
