...
<head>
	...
	<link rel="stylesheet" media="all" href="__Public__/Css/isotope/style.css">
	<!--绿色导航-->
	<link rel="stylesheet" media="all" href="__Public__/Css/navbar.css">
  ...
  <!-- bsie 额外的 css 补丁文件 -->
    ...
    <![endif]-->
	<!-- JS -->
	<script src="__Public__/Js/isotope/jquery-1.7.1.min.js"></script>
	...
	<!-- Isotope -->
	<script src="__Public__/Js/isotope/jquery.isotope.min.js"></script>
	...
	<style>
		...
		@media (min-width: 1200px) {
			...
			#ceright{padding-top:80px;}
			#celeft{padding-top:80px;}
		}
         ...
         success:function(json){
            if(json){
                ...
                for(var i=0; i<l; i++){
                     n = json[i]; 
					if(n.post_add)
						$item = $('<figure class="'+n.league_class +' isotope-item"><a href=\"javascript:void(0);\" class=\"thumb\"><img  src="__Uploads__/ActivityPost/m_'+n.post_add+'" alt=\"alt\" data-toggle="modal" href="#myModal" /></a><figcaption><div class="heading"><a data-toggle="modal" href="#myModal" class="activityname" id="'+n.id+'">'+n.name+'</a><a href="#" title="关注此活动"><img src="__Public__/Images/attention.png"/></a></div><p>主办方：<a href="#">'+n.league_name+'</a><a href=\"#\" title=\"关注此社团\"><img src=\"__Public__/Images/attention-small.png\"/></a></p><p>时间：'+n.start_time+'</p><p>地点：'+n.place+'</p></figcaption></figure>');
					else
                         ...
                         <li class="dropdown" >
							...
							<b class="caret"></b> </a>
                             <ul class="dropdown-menu">		
								...
								<li><a href="/herald_league/index.php/League/Admin/adminAlbumList/leagueid/<?php echo ($loginuserid); ?>">上传照片</a></li>
								<li><a href="">社团空间</a></li>
...
<div id="loginModal" class="modal hide fade " style="width:560px;margin-left:-280px;">
	...
	<form class="form-horizontal" style="margin-top:30px;margin-bottom:0;" action="" method="post">
		...
		<div class="modal-footer">
			<form><button id="leaguelogin" type="submit" class="btn btn-primary" data-dismiss="modal">登录</button>
			<a href="javascript:void(0);" class="btn" data-dismiss="modal" id="leaguelogincancle">取消</a></form>
		</div>
	</form>
</div>
